...
final class RouterServiceTests: XCTestCase {
    ...
    func test_routerService_automaticallyRegistersProtocolOfItself() {
        ...
        let storedInstance = service.store.get(RouterServiceNavigationProtocol.self)
    ...
    func test_routerServiceRegister_callsStore() {
        ...
        service.register(dependency: dep, forType: RouterServiceDoubles.MockConcreteDependency.self)

        XCTAssertTrue(
            storeSpy.registerArgumentPassed as? RouterServiceDoubles.MockConcreteDependency === dep
        )
    ...
    func test_routerService_suceedsRoutingIfTheresHandler() {
        ...
        let dep = RouterServiceDoubles.MockConcreteDependency()
        service.register(dependency: dep, forType: RouterServiceDoubles.MockConcreteDependency.self)
        service.register(dependency: dep, forType: MockDependencyProtocol.self)
